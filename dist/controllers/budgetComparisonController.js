...
function handleBudgetComparison(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      1. Preço total (Preste bastante atenção nos valores) (qual orçamento é mais barato no geral)
      2. Preço por item (Preste bastante atenção nos valores) (identificar itens específicos mais baratos em cada orçamento)
